...
```powershell
$u='https://raw.githubusercontent.com/bakunity/RDP/v1.0.6/scripts/install-client.ps1'; & ([scriptblock]::Create((irm $u))) -Server 'SERVER_IP_OR_DOMAIN' -PairCode 'PAIR_CODE' -Fingerprint 'FINGERPRINT' -Name 'Название ПК' -RepositoryRef 'v1.0.6'
```
...
-RepositoryRef  тег или ветка агента, для продакшена v1.0.6
```
