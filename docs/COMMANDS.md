...
```powershell
$u='https://raw.githubusercontent.com/bakunity/RDP/v1.0.4/scripts/install-client.ps1'; & ([scriptblock]::Create((irm $u))) -Server 'SERVER' -PairCode 'CODE' -Fingerprint 'FINGERPRINT' -Name 'PC NAME' -RepositoryRef 'v1.0.4'
```

## Stable update v1.0.4

Server:

```bash
curl -fsSL https://raw.githubusercontent.com/bakunity/RDP/v1.0.4/scripts/update-server.sh -o /tmp/update-hermes-rdp.sh
sudo env HERMES_RDP_REF=v1.0.4 bash /tmp/update-hermes-rdp.sh
...
```powershell
$u='https://raw.githubusercontent.com/bakunity/RDP/v1.0.4/scripts/update-client.ps1'; & ([scriptblock]::Create((irm $u))) -RepositoryRef 'v1.0.4'
```
...
```powershell
$u='https://raw.githubusercontent.com/bakunity/RDP/v1.0.4/scripts/uninstall-client.ps1'; & ([scriptblock]::Create((irm $u)))
```

Server, только после backup:

```bash
curl -fsSL https://raw.githubusercontent.com/bakunity/RDP/v1.0.4/scripts/uninstall-server.sh -o /tmp/uninstall-hermes-rdp.sh
...
v1.0.4: https://github.com/bakunity/RDP/releases/tag/v1.0.4
```
