...
3. [`NEXT_WORK.md`](NEXT_WORK.md) — вектор целей, приоритеты и критерий готового продукта.
4. [`DECISIONS.md`](DECISIONS.md) — важные архитектурные решения и ограничения, которые нельзя потерять.
5. [`SESSION_PROTOCOL.md`](SESSION_PROTOCOL.md) — как обновлять эту папку перед следующим переездом в новый чат.
6. [`HISTORY.md`](HISTORY.md) — крупные этапы развития проекта.
...
- Current main at context creation: `6cecc33d520e8bd07c322d660c200a454d17e93f`
- Latest published GitHub Release at context creation: `v1.1.0`
